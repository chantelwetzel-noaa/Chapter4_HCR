...
print.letter(xy = c(0.19, 0.22), bthres)
print.letter(xy = c(0.28, 0.32), "MSST")
print.letter(xy = c(0.50, 0.42), bproxy)
...
print.letter(xy = c(0.19, 0.25), bthres)
print.letter(xy = c(0.33, 0.34), "MSST")
print.letter(xy = c(0.60, 0.57), bproxy)
#print.letter(xy = c(0.19, 0.80), bthres)
...
lines(seq(high,1,step), out$abc[z2:length(out$abc)]-0.10, lty = 2, lwd = 2, col = acl.col)
lines(seq(low,high,step), out$abc.hcr, lty = 2, lwd = 2, col = acl.col)
print.letter(xy = c(0.28, 0.37), bthres)
print.letter(xy = c(0.38, 0.44), "MSST")
print.letter(xy = c(0.70, 0.73), bproxy)
...
mtext(side=2,"Annual catch limit",line=1, cex=1, outer = T)
...
lines(seq(high,1,step), out$abc[z2:length(out$abc)]-0.10, lty = 2, lwd = 2, col = acl.col)
lines(seq(low,high,step), out$abc.hcr, lty = 2, lwd = 2, col = acl.col)
print.letter(xy = c(0.28, 0.41), bthres)
print.letter(xy = c(0.48, 0.57), "MSST")
print.letter(xy = c(0.89, 0.63), bproxy)
#print.letter(xy = c(0.28, 0.80), bthres)
